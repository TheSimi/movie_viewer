...
uv run pyinstaller --onedir -n "movie_viewer" --noconsole --icon="assets\icon.ico" --add-data "styles;styles" --add-data "assets;assets" --collect-submodules selenium main.py
